...
function addShareWX() {
  ...
  n.src = "http://game.ikongzhong.cn/games/xiongchumo/2000.png";
  n.id = "share-wx-img";
...
function isMobile() {
  return navigator.userAgent.match(
    /android|iphone|ipod|blackberry|meego|symbianos|windowsphone|ucbrowser/i
  );
}
function isIOS() {
  return navigator.userAgent.match(/iphone|ipod|ios/i);
}
var HOME_PATH = "http://game.ikongzhong.cn/games/",
  RESOURCE_IMG_PATH = RESOURCE_IMG_PATH || "/game/",
  HORIZONTAL = HORIZONTAL || false,
  COVER_SHOW_TIME = COVER_SHOW_TIME || 2e3;
var imgUrl =
  HOME_PATH + "http://game.ikongzhong.cn/games/xiongchumo/wenzhangku.png";
var lineLink = HOME_PATH;
var descContent = "快来跟我一起玩！";
var shareTitle = "最好玩的小游戏就空中传媒小游戏！";
var appid = "";
...
(function () {
  ...
  var e = document.createElement("div");
  e.style.cssText =
    "position:absolute;z-index:1000000;left:0;top:0;background-size: 50%;width:" +
    window.innerWidth +
    "px;height:" +
    Math.max(window.innerHeight, window.document.documentElement.offsetHeight) +
    "px";
  ...
  t.style.cssText =
    "position:absolute;z-index:999999;left:0;top:0;background-size: 50%;";
